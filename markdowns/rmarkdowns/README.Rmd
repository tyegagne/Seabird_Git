...
```{r,fig.width=6, fig.height=13,fig.retina=2,tidy=TRUE}
...
*The mixing model (for publication) was run for 3 chains over 100,000 iterations, removing 50,000 for burn-in and thinning by a factor of 50. 
*NOTE: this mardown is an abbreviated short MCMC run, convergence is not acheived*
...
#save(data_box, file =  "mix_run_July3" )
...
grid.arrange(
  ...
  SST_x_PDO,
            ...
            layout_matrix = lay)
```
Final fig (fig in pub received minor post-processing)
